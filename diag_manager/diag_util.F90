...
END SUBROUTINE check_bounds_are_exact_dynamic
  ...
  SUBROUTINE init_file(name, output_freq, output_units, data_format, time_units, long_name, tile_count,&
    ...
    files(num_files)%data_format = data_format
